...
/**
 * Explore_Demo_Importer Class.
 */
class Explore_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'explore' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'explore' ), __( 'Demo Importer', 'explore' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
